...
Use the **integrate-nestjs-xotp** skill ([nestjs-xotp](https://github.com/farshidbeheshti/nestjs-xotp/tree/main/skills/integrate)) or install `nestjs-xotp@nestjs-xotp-plugins` for `XOTPModule`, DI, `forRootAsync`, and example module layout.
